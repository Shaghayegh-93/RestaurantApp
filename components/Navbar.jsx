...
const Navbar = ({ menuHandler, open }) => {
  return (
    <div className="flex items-center justify-between h-[100px]  bg-[#d1411e] p-[10px] lg:px-[50px] sticky top-0 z-10">
      ...
      {/* center */}
      <div className="hidden lg:flex lg:items-center lg:justify-center lg:flex-[3_3_0%]">
      ...
      <div>
        <div
          className="w-[25px] h-5 cursor-pointer flex flex-col justify-between lg:hidden relative "
          onClick={menuHandler}
        >
        ...
        />
        <ul
          className=" fixed h-[calc(100vh-100px)] w-[50vw] bg-[#d1411e] top-[100px] font-bold text-white flex flex-col items-center justify-around z-10 transition-all duration-1000 peer-checked:right-[-50vw] md:hidden right-0
           "
