...
const PizzaList = () => {
  return (
    <div className="py-5 px-[10px] flex flex-col items-center ">
      <h1 className="font-bold text-3xl mb-8">THE BEST PIZZA IN TOWN</h1>
      <p className="text-2xl text-[#444] w-[65%]">
      ...
      <div className="flex items-center justify-around w-full flex-wrap mt-8">
        <PizzaCard />
        <PizzaCard />
        <PizzaCard />
        <PizzaCard />
