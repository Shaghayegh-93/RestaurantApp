      ...
      <div className="flex-[2_2_0%]  ">
        <div>
          ...
          <div className="flex w-full items-center justify-evenly">
            <div className={`flex flex-col items-center  ${indexClass(0)}`}>
            ...
            <div className={`flex flex-col items-center ${indexClass(1)}`}>
            ...
            <div className={`flex flex-col items-center ${indexClass(2)}`}>
            ...
            <div className={`flex flex-col items-center ${indexClass(3)}`}>
